  ...
  return (
    <div className="bg-light-background dark:bg-dark-background px-4 py-1 max-[994px]:w-screen">
      <div className="bg-light-backgroundSecond dark:bg-dark-backgroundSecond h-10 rounded-[10px] flex items-center px-2 py-0">
        {icon ?? <SearchIcon fontSize="small" style={{ color: "#919191" }} />}
        <input
          type="search"
          className="flex-1 border-0 outline-0 dark:border-0 dark:outline-0 rounded-[10px] -mr-2 bg-transparent ml-3 text-light-text dark:text-dark-text"
